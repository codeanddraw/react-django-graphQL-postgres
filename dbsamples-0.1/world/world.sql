...
-- To alter tables and column names
ALTER TABLE city rename to worldapi_city;
ALTER TABLE country rename to worldapi_country;
ALTER TABLE countrylanguage rename to worldapi_countrylanguage;

-- column renames of worldapi_city 
ALTER TABLE worldapi_city
RENAME id TO city_id;
...
ALTER TABLE worldapi_city
RENAME population TO city_population;

-- column renames of worldapi_countrylanguage 
ALTER TABLE worldapi_countrylanguage
RENAME countrycode TO countrylanguage_countrycode;

ALTER TABLE worldapi_countrylanguage
RENAME language TO countrylanguage_language;

ALTER TABLE worldapi_countrylanguage
RENAME isofficial TO countrylanguage_isofficial;

ALTER TABLE worldapi_countrylanguage
RENAME percentage TO countrylanguage_percentage;

-- column renames of worldapi_country table 
ALTER TABLE worldapi_country
...
ALTER TABLE worldapi_country
RENAME continent TO country_continent;

ALTER TABLE worldapi_country
RENAME region TO country_region;

ALTER TABLE worldapi_country
RENAME surfacearea TO country_surfacearea;

ALTER TABLE worldapi_country
RENAME indepyear TO country_indepyear;

ALTER TABLE worldapi_country
RENAME population TO country_population;

ALTER TABLE worldapi_country
RENAME lifeexpectancy TO country_lifeexpectancy;

ALTER TABLE worldapi_country
RENAME gnp TO country_gnp;

ALTER TABLE worldapi_country
RENAME gnpold TO country_gnpold;

ALTER TABLE worldapi_country
RENAME localname TO country_localname;

ALTER TABLE worldapi_country
RENAME governmentform TO country_governmentform;

ALTER TABLE worldapi_country
RENAME headofstate TO country_headofstate;

ALTER TABLE worldapi_country
RENAME capital TO country_capital;

ALTER TABLE worldapi_country
RENAME code2 TO country_code2;
